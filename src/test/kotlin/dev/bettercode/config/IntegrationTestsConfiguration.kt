...
@Import(ProjectsConfiguration::class, TasksConfiguration::class)
@Configuration
class IntegrationTestsConfiguration {
    ...
    fun entityManagerFactory(dataSource: DataSource): LocalContainerEntityManagerFactoryBean? {
        ...
        em.setPackagesToScan("dev.bettercode.tasks.infra.adapter.db.jdbc", "dev.bettercode.projects.infra.adapter.db.jdbc")
